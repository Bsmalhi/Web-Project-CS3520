...
public class SendEmail extends HttpServlet {
    ...
    public static void sendEmail(String email, String message){
        ...
        try{
           Send("com.willsuwei.cs3520", "cs3520admin", email, "", "Snap Chat", message);
       } catch(Exception e){
   ...
   public static void main(String [] args){
       try{
           Send("com.willsuwei.cs3520", "cs3520admin", "willsuwei@hotmail.com", "", "testmessageTitle", "Test message context");
       } catch(Exception e){
           System.out.println(e);
           e.printStackTrace();
       }
